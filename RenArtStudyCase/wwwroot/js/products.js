...
<p class="price">$${product.price.toFixed(2)} <span class="currency">USD</span></p>
                            <div class="color-picker">
                                <button class="yellow" onclick="changeColor('${product.name}', '${product.images.yellow}', 'Yellow Gold')"></button>
<button class="white" onclick="changeColor('${product.name}', '${product.images.white}', 'White Gold')"></button>
<button class="rose" onclick="changeColor('${product.name}', '${product.images.rose}', 'Rose Gold')"></button>
...
function changeColor(productName, imageUrl, colorName) {
